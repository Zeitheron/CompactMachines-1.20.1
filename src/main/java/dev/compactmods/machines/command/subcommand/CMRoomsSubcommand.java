...
public class CMRoomsSubcommand
{
	...
	private static int fetchByMachineBlock(CommandContext<CommandSourceStack> ctx)
	...
	private static int findByContainingPlayer(CommandContext<CommandSourceStack> ctx)
			throws CommandSyntaxException
	{
	...
	public static int findByOwner(CommandContext<CommandSourceStack> ctx)
			throws CommandSyntaxException
	{
