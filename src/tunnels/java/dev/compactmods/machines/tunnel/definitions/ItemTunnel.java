		...
		implements TunnelDefinition, CapabilityTunnel<ItemTunnel.Instance>, TunnelTeardownHandler<ItemTunnel.Instance>
{
	 ...
	 *
	 * @param capType
	 * 		Capability type. See implementations like {@link IItemHandler} as a reference.
	 *
	 ...
	 *
	 * @param instance
	 * 		The tunnel instance being modified.
	 */
	@Override
	...
	public static class Instance
			implements TunnelInstance, INBTSerializable<CompoundTag>
	{
